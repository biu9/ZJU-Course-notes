...
#define timestamp     "2524608000000"
...
#define AT_MQTT_CID           "AT+MQTTCID=%s|securemode=2\\,signmethod=hmacsha256\\,timestamp=%s|\r"
...
int parse(String data){
  ...
  if(ColorRed != 0)
    ColorRedTmp = ColorRed;
  if(ColorGreen != 0)
    ColorGreenTmp = ColorGreen;
  if(ColorBlue != 0)
    ColorBlueTmp = ColorBlue;
  ColorRed = ColorRedTmp;
  ColorGreen = ColorGreenTmp;
  ColorBlue = ColorBlueTmp;
